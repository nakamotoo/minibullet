...
class BinSortNeutralMultStored:
    ...
    def __init__(self, env, pick_height_thresh=-0.31, xyz_action_scale=7.0,
                 ...
                 correct_bin_per=1.0, open_steps=5, num_attempts=2, use_stored_noise=True):
        self.env = env
    ...
    def swap_objects(self):
        ...
        copy = list(self.env.object_names).copy()
        copy.remove(self.object_to_target)
        self.object_to_target = np.random.choice(copy)
...
class BinSortMultStored(BinSortNeutralMultStored):
        ...
        def __init__(self, env, pick_height_thresh=-0.31, xyz_action_scale=7.0,
                        ...
                        correct_bin_per=1.0, open_steps=5, num_attempts=2):
